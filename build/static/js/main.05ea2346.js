/*! For license information please see main.05ea2346.js.LICENSE.txt */
!function () {
    "use strict";
    var e = {
        463: function (e, t, n) {
    ...
    n.m = e, n.d = function (e, t) {
        ...
        function He() {
            var t = function () {
                ...
                i = a[1], c = function () {
                    var e = s(u().mark((function e(t, n) {
                        var r, a;
                        return u().wrap((function (e) {
                            for (; ;) switch (e.prev = e.next) {
                                case 0:
                                    return n.preventDefault(), (r = new FormData).append("image", t.image[0]), t.invert && r.append("invert", "true"), "" !== t.scale && r.append("scale", t.scale), "" !== t.distrType && r.append("distr_type", t.distrType), e.next = 8, fetch("http://localhost:5000/", {
                                        method: "POST",
                                        body: r
                                    }).then((function (e) {
                                        return e.json()
...
//# sourceMappingURL=main.05ea2346.js.map